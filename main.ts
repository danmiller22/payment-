...
const MESSAGE_TEXT = [
  ...
  "Мы работаем по честной системе 50/50 — вы платите за результат, а не за обещания.",
  "",
  "Подписка навсегда стоит 1500 сом:",
  "750 сом — перед вступлением в группу,",
  "750 сом — уже после того, как найдёте через нас квартиру и заселитесь.",
  "",
  "Каждый день в закрытой группе появляется до 100 новых, бюджетных квартир напрямую от хозяев.",
  "Наши клиенты в среднем находят жильё за 1–3 дня.",
  "",
  ...
  "",
  "Вторую часть — 750 сом — вы оплачиваете только после заселения, также прикрепив чек.",
].join("\n");
